...
// CADASTRAL CLAIMANTS (original layer restored)
var format_CADASTRALCLAIMANTS_1 = new ol.format.GeoJSON();
var features_CADASTRALCLAIMANTS_1 = format_CADASTRALCLAIMANTS_1.readFeatures(json_CADASTRALCLAIMANTS_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CADASTRALCLAIMANTS_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_CADASTRALCLAIMANTS_1.addFeatures(features_CADASTRALCLAIMANTS_1);
var lyr_CADASTRALCLAIMANTS_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_CADASTRALCLAIMANTS_1, 
                style: style_CADASTRALCLAIMANTS_1,
                popuplayertitle: 'CADASTRAL CLAIMANTS',
                interactive: true,
                title: '<img src="styles/legend/CADASTRALCLAIMANTS_1.png" /> CADASTRAL CLAIMANTS'
            });

// --- merged additional layers ---
...
// default visibility for layers
lyr_GoogleSatelliteHybrid_0.setVisible(true);lyr_CADASTRALCLAIMANTS_1.setVisible(true);lyr_AREAFEATURES_0.setVisible(false);lyr_BRGYBOUNDARY2_1.setVisible(false);lyr_CEBECOPOST_2.setVisible(false);lyr_ATLSTENEMENTPERBATGY_3.setVisible(false);lyr_BARANGAYPARTITION_4.setVisible(false);lyr_LINEFEATURES_5.setVisible(false);lyr_PHLADM3_6.setVisible(false);lyr_PSABUILDINGFOOTPRINT_7.setVisible(false);lyr_TOLEDOPARCELS_8.setVisible(false);lyr_TOLEDOBASESHAPE_9.setVisible(false);lyr_TOLEDOLANDUSEFINAL_10.setVisible(false);
var layersList = [lyr_GoogleSatelliteHybrid_0,lyr_CADASTRALCLAIMANTS_1,lyr_AREAFEATURES_0,lyr_BRGYBOUNDARY2_1,lyr_CEBECOPOST_2,lyr_ATLSTENEMENTPERBATGY_3,lyr_BARANGAYPARTITION_4,lyr_LINEFEATURES_5,lyr_PHLADM3_6,lyr_PSABUILDINGFOOTPRINT_7,lyr_TOLEDOPARCELS_8,lyr_TOLEDOBASESHAPE_9,lyr_TOLEDOLANDUSEFINAL_10];
