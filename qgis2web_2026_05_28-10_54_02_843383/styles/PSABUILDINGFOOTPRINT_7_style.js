...
var style_PSABUILDINGFOOTPRINT_7 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
        ...
        if (feature.get("HH_Head") !== null && resolution > 0 && resolution < 0) {
            labelText = String(feature.get("HH_Head"));
        }
